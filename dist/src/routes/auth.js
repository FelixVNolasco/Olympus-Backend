...
router.post("/signup", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const newUser = new User({
        ...
        password: crypto_js_1.default.AES.encrypt(req.body.password, process.env.SEC_PASSJS).toString(),
    });
    try {
...
router.post('/login', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const hashedPassword = crypto_js_1.default.AES.decrypt(user.password, process.env.SEC_PASSJS);
        ...
        }, process.env.SEC_PASSJWT, { expiresIn: "3d" });
